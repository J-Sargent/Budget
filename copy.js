function copyBudget(copyDate) {
  var budgetData = sheets.budget.getRange("A3:C").getDisplayValues();
  var yearlyData = sheets.yearly.getRange("A1:D").getDisplayValues();
  ...
  var lastRow = sheets.future.getLastRow();
  sheets.future
    .getRange(
      lastRow + 1,
      1,
